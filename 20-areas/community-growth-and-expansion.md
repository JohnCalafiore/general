...
- John noted two startup-guide items in Slack: send the startup guide to Greg (#open), and
  consider adding a "how to recruit facilitators" section.
- action #open (John): send startup guide to Greg (who Greg is → see needs-clarification)
- category: Community Growth and Expansion
- source: Slack DMs John→Andrew 2026-07-21 (permalinks in raw/slack.md)

## 2026-07-21 Two new website contact-form leads: Zoe Funk and Matt Budde
- Both submitted the contact-us form on dudetalkdinners.org (HubSpot notifications).
  Follow-up status unknown.
- category: Community Growth and Expansion
- source: HubSpot form-submission emails 2026-07-21

## 2026-07-20 Cole to join the Leadership Circle after the Frisco Dinner
- Ken Farber met Cole (colepmhnp@gmail.com) at the July Frisco Dinner; Cole confirmed he
  wants deeper involvement: "I look forward to being included with the Leadership Team."
  John had committed (Jul 18) to adding him to the Leadership Circle list and Slack
  channel. Leadership hosts monthly calls.
- action #open (John): add Cole to the Leadership Circle list and Slack
- category: Community Growth and Expansion
- source: "Dude Talk Leadership Call" email thread 2026-07-18→20
- links: [[relationships#Cole]]
