...
- Program details (CDPHE Office of Suicide Prevention / EDC): free national academy;
  Part 1 Aug 13 (10–12 MT), Part 2 Aug 25–26 (9–4 MT both days), Part 3 Sep 22 (10–12
  MT). Team of 4 including a Zero Suicide initiative lead; letter of commitment from the
  CEO/executive director required; **application due EOD July 31** (acceptance by Aug 6);
  rural systems prioritized. CDPHE contacts: Jazmin Murguia, Katherine Harvey.
- Status: Chris Peterson available all days; Chris Gould can make the days work; Ken has
  a conflict on Aug 26 (would try to reschedule if needed as the 4th). Ken flagged the
  eligibility catch — "Only Colorado health systems (mental, physical, behavioral) are
  eligible" — and asked whether DTD qualifies.
- Andrew: worthwhile despite the time commitment; wants to strengthen DTD's standing as
  an authority in suicide prevention (learning, program model, partnerships, facilitator
  trainings, media presence, fundraising avenues).
- action #open (Andrew): email CDPHE to confirm DTD's eligibility; start the application
  if a team firms up — deadline Jul 31
- category: Governance and Organizational Development
- source: "Colorado Zero Suicide Academy" thread 2026-07-25 (Ken, Andrew, Chris G.)
...
- Justin Hall shared the Google Doc "Draft Minutes for 7/17/26 DTD Board Meeting" with the
  full board (John, Andrew Wolff, Benjamin Shay, Chris Gould, Chris Peterson, Ken Farber)
  for comment.
- category: Governance and Organizational Development
- source: Drive share email from Justin Hall 2026-07-21

## 2026-07-19 IRS approves 501(c)(3) status for Dude Talk Dinners, Inc.
- The IRS determination letter arrived: Dude Talk Dinners, Inc. is recognized as tax-exempt
  under Section 501(c)(3). Ken Farber led the application; the board noted an unusually
  fast turnaround. EIN: 41-4806880.
- category: Governance and Organizational Development
- source: email from Andrew Wolff to the board 2026-07-19; EIN from John's email to
  Patricia Markwell (RMCP) 2026-07-20
