...
- Patricia Markwell introduced John and Andrew to Bev Marquez, RMCP's CEO of 16 years. Bev
  replied warmly — Brandon, Erik, and Patricia have expressed "absolute support" — and
  invited scheduling a direct meeting.
- action #open (John/Andrew): schedule an intro call with Bev Marquez
- category: Partnerships and Strategic Relationships
- source: "E-Intro" email thread 2026-07-20/21
- links: [[relationships#Bev Marquez]]

## 2026-07-20 Grant platform meeting with Patricia Markwell (RMCP)
- 30-minute Teams meeting (1:00pm MT), John + Patricia Markwell (Director of Development,
  Rocky Mountain Crisis Partners). From her same-day follow-up email:
  - Brianna Martinez (briannam@rmcrisispartners.org) available to walk through RMCP's CRM
    and how they track grants and contacts.
  - Grant consultant recommendation: Amanda Kearney-Smith, The Nonprofit Strategy Group
    (amanda@thenonprofitstrategygroup.com), ~$125/hr, has membership access to grant
    databases DTD would otherwise need a subscription for.
  - Patricia will intro RMCP's CEO Bev Marquez (done — see entry above).
  - Patricia is on parental leave from Aug 5 (possibly earlier) to the first week of
    October; stay connected with her team meanwhile.
  - John sent DTD's EIN (41-4806880) as requested.
- action #open (John/Andrew): decide whether to engage Amanda Kearney-Smith; contact
  Brianna about the CRM if useful
- category: Partnerships and Strategic Relationships
- source: calendar event 2026-07-20 + follow-up email from Patricia Markwell 2026-07-20
- links: [[funding-and-financial-development]], [[relationships#Patricia Markwell]]
