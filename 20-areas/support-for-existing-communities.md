...
- Andrew, John, and Ken are driving to Buena Vista Thursday for the DTD dinner (Andrew
  driving from his place). Ken suggested leaving earlier to connect with Justin and/or
  the other facilitators before the dinner. This is the in-person follow-through on BV's
  funding crunch and the facilitators' "We Believe in DTD" commitment — Andrew's recap
  action to "schedule BV visit w/ Erik; then capture testimonials."
- category: Support for Existing Communities
- source: "DTD BV roadtrip" calendar invite + Ken's reply 2026-07-31
- links: [[funding-and-financial-development#2026-07-30 Buena Vista funding gap — the test case for community funding]]
