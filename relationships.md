...
People and organization map, extracted from communication over time. Maintained by the
synthesis agent; correct anything wrong and the agent will respect your edits.

Format — one H2 per person:

```
## Jane Doe
- org: Acme Corp — role: Structures lead
- projects: [[10-projects/canopy-redesign/README|Canopy Redesign]]
- relationship: external consultant, primary contact for structural calcs
- source: intro email 2026-07-02
```
...
- relationship: primary RMCP contact for the DTD partnership and grant strategy; on
  parental leave Aug 5 → early October 2026
- source: "Follow up" email 2026-07-20; grant platform meeting 2026-07-20
...
- email: briannam@rmcrisispartners.org
- source: Patricia Markwell email 2026-07-20

## Erik (Johnson?) — erikj@rmcrisispartners.org
- org: Rocky Mountain Crisis Partners — works alongside DTD activating communities (per
  Andrew); full name not yet seen in the record
- source: "E-Intro" thread 2026-07-20

## Amanda Kearney-Smith
- org: The Nonprofit Strategy Group — grant consultant, ~$125/hr, membership access to
  grant databases; recommended by Patricia Markwell (RMCP has worked with her)
- email: amanda@thenonprofitstrategygroup.com
- source: Patricia Markwell email 2026-07-20
